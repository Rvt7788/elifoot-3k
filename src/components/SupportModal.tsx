  ...
  return (
    <InfoModal icon="finance" title="Apoie o projeto" onClose={onClose}>
      ...
      <div className="mb-5 flex flex-col items-center gap-2">
        ...
        <button onClick={copyPix} className="btn-cta inline-flex w-fit items-center gap-2 px-4 py-2 text-[13px]">
          <GameIcon name="finance" size={15} /> {copied ? "Chave copiada" : "Copiar chave Pix"}
        </button>
      </div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <a
          ...
          className="btn-cta inline-flex w-fit items-center gap-2 px-4 py-2 text-[13px]"
        >
          <GameIcon name="proposal" size={15} /> Enviar sugestão
        </a>
        <a
          href={FORM_URL}
          target="_blank"
          ...
          className="btn-cta inline-flex w-fit items-center gap-2 px-4 py-2 text-[13px]"
        >
          <GameIcon name="deal" size={15} /> Falar de parceria
        </a>
      </div>
    </InfoModal>
  );
